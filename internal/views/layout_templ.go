...
func Layout(title string, content templ.Component) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "</title><script src=\"https://cdn.jsdelivr.net/npm/@tailwindcss/browser@4\"></script><script src=\"/static/solve.js\"></script><link rel=\"stylesheet\" href=\"/static/styles.css\"></head><body class=\"bg-gray-900 text-white min-h-screen flex flex-col items-center justify-center\"><h1 class=\"text-3xl font-bold mb-8\">Sudoku</h1>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
